...
def main():
    ...
    query = "J K Dobbins"
    #filter_dict = {"pos": "RB", "rookie": "Yes", "ADP": {"$lte": 100}}
    #docs_with_score = db.similarity_search_with_score(query, k=3, filter=filter_dict)
    ...
    for doc, score in docs_with_score:
        ...
        print("Outlook:", doc.page_content[:200] + "...")  # Print first 200 characters
        print("-" * 80)
